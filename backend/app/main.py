...
async def global_exception_handler(request: Request, exc: Exception):
    ...
    Returns full traceback in DEBUG mode, generic message in production.
    """
    # Log the exception with full traceback (appears in terminal/file with colors)
    logger.exception(exc)
    
    if settings.DEBUG:
        # Development mode: Return full traceback
...
async def root():
    ...
    return {"message": "MDP Platform Demo API"}
